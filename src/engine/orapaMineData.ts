...
// Border positions for a 10×8 square grid.
// Letters A–R (18): A–J along the bottom edge, K–R along the right edge.
// Numbers 1–18 (18): 1–10 along the top edge, 11–18 along the left edge.
